...
setup(
    ...
    entry_points={
        'console_scripts': [
            'joystick_mapper=slvrov_core_python.control.joystick_mapper:main',
            'joystick_logic=slvrov_core_python.control.old_joystick_logic:main',
            'pca9685_node=slvrov_core_python.control.pca9685_node:main',
            'pin_mappings_client=slvrov_core_python.control.pin_mappings_client:main',
            'pin_mappings_server=slvrov_core_python.control.pin_mappings_server:main',
        ],
    },
)
